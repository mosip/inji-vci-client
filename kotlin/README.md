...
- The OpenID4VCI 1.0 migration and Draft-13 compatibility design for this Kotlin library is documented in [ADR-0001](../doc/adr/0004-openid4vci-v1-migration.md).
...
For information on upgrading between versions, see the [Migration Guide](../doc/adr/migration-guide/MIGRATION_0.7.0_TO_1.0.0.md).
